...
@Component
public class MedicoResponsavelBean {
    private Integer medico_responsavel_id;
    private String medico_responsavel;
    private String telefone_medico;

    public MedicoResponsavelBean() {
    }

    public MedicoResponsavelBean(Integer medico_responsavel_id, String medico_responsavel, String telefone_medico) {
