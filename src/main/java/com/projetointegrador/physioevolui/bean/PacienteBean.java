...
public class PacienteBean {
    ...
    public PacienteBean(Integer int_id_paciente) {
        this.int_id_paciente = int_id_paciente;
    }

    public PacienteBean(Integer int_id_paciente, String str_nome_paciente, Date date_data_nascimento_paciente, String str_cpf_paciente, String str_rg_paciente, Integer int_sexo_paciente, Integer int_estado_civil_paciente, String str_email_paciente, String str_telefone_paciente, String str_convenio_paciente, String str_profissao_paciente, String str_endereco_paciente, Integer int_cep_paciente, String str_bairro_paciente, ErroBean erroBean) {
        this.int_id_paciente = int_id_paciente;
    ...
    public PacienteBean(ErroBean erroBean) {
        this.erroBean = erroBean;
    }
